...
const getIconPath = (
  name: 'plane' | 'calendar' | 'user' | 'switch' | 'search' | 'price' | 'complete' | 'support',
...
const SearchWidget = () => {
  ...
  const handleDateChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === 'departureDate' && tripType === 'roundTrip' && value) {
      ...
      if (!flightData.returnDate || new Date(flightData.returnDate) < new Date(nextDay)) {
         setFlightData(prev => ({ ...prev, returnDate: nextDay }));
      }
    }
  };
  ...
  const renderForm = () => {
    ...
    const genericHandler = handleFlightChange;
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-2xl w-full max-w-5xl">
      <div className="flex border-b border-gray-200 mb-4">
        <div className="flex items-center pb-3 pt-1 px-4 text-base font-semibold text-[#0A58CA] border-b-2 border-[#0A58CA]">
...
export default function Home() {
  ...
  const promos = [
    ...
    },
    {
      ...
      title: "Promo Penerbangan ke Yogyakarta",
    ...
    },
    {
      ...
      description: "Perjalanan super kilat dengan pesawat hanya 1 jam."
    }
  ];
  ...
  const features = [
    ...
    },
    {
        ...
        description: "Ratusan maskapai terintegrasi di seluruh Indonesia dan dunia.",
    ...
    <div className="font-sans">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-xl mb-8 drop-shadow-md" data-aos="zoom-in" data-aos-delay="300">Pesan tiket pesawat dengan harga terbaik!</p>
      ...
      <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
              ...
              <p className="text-center text-gray-600 mb-10" data-aos="fade-down" data-aos-delay="200">Jelajahi tempat-tempat favorit dengan penawaran penerbangan termurah.</p>
