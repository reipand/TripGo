    ...
    if (fetchError) {
      ...
      if (fetchError.code === 'PGRST116') {
        ...
        if (createError) {
          ...
          // Throw the error with proper formatting
          throw new Error(`Create wallet error: ${createError.message || JSON.stringify(createError)}`);
        }
        ...
        // Other errors - throw with proper formatting
        throw new Error(`Fetch wallet error: ${fetchError.message || JSON.stringify(fetchError)}`);
      }
    } else {
